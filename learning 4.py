...
while quit_game == False:
    ...
    # Quits game if snake hits the walls -- need to update the variables when resizing
    if snake_x > screen_size_x or snake_x < 0 or snake_y > screen_size_y or snake_y < 0:
        quit_game = True
